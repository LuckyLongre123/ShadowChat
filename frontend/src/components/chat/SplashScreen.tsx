...
/**
 * SplashScreen — WhatsApp-style full-viewport loading indicator.
 *
 * Used in two places:
 * 1. loading.tsx — rendered by Next.js during server-side streaming.
 * 2. ChatLayout  — rendered while auth.isLoading is true (Zustand auth check).
 *
 * Keeping both the same component guarantees a seamless visual handoff
 * with zero flicker between the two loading phases.
 */
